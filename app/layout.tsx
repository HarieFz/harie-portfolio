...
export const metadata: Metadata = {
  ...
  description:
    "Hi! I'm Harie Fairuz Zaki, a web developer passionate about crafting intuitive, responsive, and visually engaging websites. I'm currently open to job opportunities—let's connect!",
...
export default function RootLayout({
  ...
  return (
    <html lang="en">
      <body
        className={`${poppins.variable} antialiased relative bg-dark-navy h-dvh lg:overflow-hidden 2xl:pt-25.5 2xl:pb-27.75 lg:pt-20 lg:pb-15 max-lg:pt-8 max-lg:px-6`}
      >
        <RippleCursor />
